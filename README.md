...
A lightweight, educational BitTorrent client build in Python. This project crafted for understanding how torrents actually work and  demonstrates  the core mechanics of the BitTorrent protocol when i realised my hostel network blocks all P2P traffic, i decided "if i can't use BitTorrent I'll build one myself"
During my Advanced Programming Practice course, I leaned how TCP and UDP server and client communicate. this sparked my idea. i wanted to create something practical and cool so i decided to apply that knowledge to one of the most fascinating real-world protocols(BitTorrent)
This project demonstrates the foundational operations that power BitTorrent:
